...
const RestaurantMenu = () => {
  ...
  return (
    <div className="text-center">
      <header className="h-[30vh] bg-black text-[#f7f7f7] flex justify-center items-center gap-[30px]">
        <div className="menu-header-left">
          <img
            src={CDN_URL + cloudinaryImageId}
            alt="Restaurent Info"
            className="w-[250px] h-[170px] rounded-md bg-cover bg-center"
          />
        </div>
      ...
      <div className="mt-[50px] ml-40 text-left">
        <Link
          to="/"
